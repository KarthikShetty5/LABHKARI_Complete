...
const deleteCartItem = async (req: NextApiRequest, res: NextApiResponse) => {
    try {
        ...
        await Cart.deleteOne({ customId: customId, userId: uid });
...
export default connectDb(deleteCartItem);
