...
const Navbar: React.FC<NavbarProps> = ({ onSearch }) => {
  ...
  return (
    <>
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-white">
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button
                  onClick={toggleModal}
                  type="button"
                  className="text-[#103178] bg-transparent hover:bg-[#103178] hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
        ...
        <div className="fixed overflow-y-auto inset-0 z-40">
          ...
          <div className="absolute inset-y-0 right-0 md:h-full h-full w-full md:w-64 bg-white shadow-lg transition-transform transform">
            ...
            <button
              ...
              className="absolute top-4 right-4 text-black focus:outline-none transition-transform transform hover:scale-110"
            >
              ...
              <ul className="flex flex-col space-y-6">
                <li>
                  ...
                  <ul className="pl-6 mt-3 space-y-3">
                    ...
                    <li>
                      <Link
                        href={{ pathname: "/category", query: { cat: "Agri" } }}
                      >
                    ...
                    <li>
                      <Link
                        href={{ pathname: "/category", query: { cat: "Home" } }}
                      >
                    ...
                    <li>
                      <Link
                        href={{ pathname: "/category", query: { cat: "Vet" } }}
                      >
        ...
        <nav className="bg-white lg:px-6 pt-2.5 pb-2 md:pb-1.5">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
              ...
              <a
                href="/cart"
                className="relative block md:ml-4 text-black text-2xl font-medium rounded-lg px-5 py-2.5 text-center"
              >
                <FaCartShopping />
              ...
              <div className="block relative top-1 md:ml-6 md:mr-0 mr-4 ml-4">
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M0 5h20V3H0v2zM0 10h20V8H0v2zm0 5h20v-2H0v2z"
                      clipRule="evenodd"
                    />
                  </svg>
                </button>
      ...
      {pathname === "/" && isSearchOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg relative w-11/12 max-w-md">
            <button
              onClick={toggleSearch}
              className="absolute top-0 right-0 text-gray-600 hover:text-gray-800 focus:outline-none"
            >
              <svg
                className="w-6 h-6"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <form onSubmit={handleSearchSubmit} className="flex items-center">
              ...
              <button
                type="submit"
                className="bg-blue-500 text-white px-2 py-2 ml-2 mr-2 rounded-md focus:outline-none focus:ring focus:border-blue-300"
              >
                Search
              </button>
            </form>
      ...
      <div
        id="default-carousel"
        className="fixed w-full top-14 md:border-0 border-t-2 border-gray-300 z-30 shadow-lg"
        data-carousel="slide1"
      >
        <div className="relative overflow-hidden h-20 lg:hidden">
          <ul
            className="flex bg-white w-full flex-wrap justify-center items-center py-3 bottom-0 lg:hidden"
            data-carousel-item1
          >
            <li className="border-r  px-5 last:border-r-0">
              <Link
                href={{ pathname: "/category", query: { cat: "Health" } }}
                className="text-black hover:text-black flex flex-col items-center space-y-1"
              >
            ...
            <li className="px-3 border-r last:border-r-0">
              <Link
                href={{ pathname: "/category", query: { cat: "Beauty" } }}
                className="text-black hover:text-black flex flex-col items-center space-y-1"
              >
            ...
            <li className="px-3 border-r last:border-r-0">
              <Link
                href={{ pathname: "/category", query: { cat: "Kitchen" } }}
                className="text-black hover:text-black flex flex-col items-center space-y-1"
              >
        ...
        <button
          type="button"
          className="lg:hidden absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
          data-carousel-prev1
        >
          <span className="inline-flex items-center justify-center">
            <svg
              ...
              width="17.906"
              height="31.91"
              className="m-auto h-4 w-2 rotate-180 lg:h-7 lg:w-14"
        ...
        <button
          type="button"
          className="lg:hidden absolute top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none"
          data-carousel-next1
        >
          <span className="inline-flex items-center justify-center">
            <svg
              ...
              width="17.906"
              height="31.91"
              className="m-auto h-4 w-2 lg:h-7 lg:w-14"
              viewBox="0 0 17.906 31.91"
              fill="black"
            >
              <path d="M0.995,31.924 C0.730,31.924 0.466,31.818 0.270,31.608 C-0.106,31.207 -0.086,30.576 0.315,30.200 L15.456,15.974 L0.315,1.748 C-0.086,1.372 -0.106,0.741 0.270,0.340 C0.645,-0.063 1.275,-0.083 1.676,0.294 L17.590,15.247 C17.791,15.435 17.905,15.699 17.905,15.974 C17.905,16.250 17.791,16.513 17.590,16.702 L1.676,31.654 C1.484,31.834 1.239,31.924 0.995,31.924 Z"></path>
      ...
      <div className="fixed bottom-0 left-0 w-full h-14 shadow-2xl bg-white px-4 py-2 flex justify-between items-center md:hidden z-30">
        ...
        {useId ? (
          <Link
            ...
            className="bloc text-black font-medium rounded-lg text-2xl text-center"
            href={""}
          >
